...
import { Chart , LinearScale , CategoryScale , BarController , BarElement , LineController  , PointElement , LineElement  } from 'chart.js';
...
function Home() {
  ...
  const services = state.ServicesApi
...
const avisCount = state.AvisCount;
const usersCount = state.UserCount;
                ...
                <div className="row">
                  <div className="col-8">
                    <div className="numbers">
                      <p className="text-sm mb-0 text-capitalize font-weight-bold">Orders</p>
            ...
            <div className="card">
              <div className="card-body p-3">
                <div className="row">
                  <div className="col-8">
                    <div className="numbers">
                      <p className="text-sm mb-0 text-capitalize font-weight-bold">Workers</p>
                      <h5 className="font-weight-bolder mb-0">
                        +3,462
            ...
            <div className="card">
              <div className="card-body p-3">
                <div className="row">
                  <div className="col-8">
                    <div className="numbers">
                      <p className="text-sm mb-0 text-capitalize font-weight-bold">Avis</p>
                      <h5 className="font-weight-bolder mb-0">
                        {avisCount}
                        <span className="text-success text-sm font-weight-bolder"></span>
                      </h5>
